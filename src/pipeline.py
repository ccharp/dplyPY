...
Functions defined in this module are tightly coupled with the `DplyFrame` class defined in dplypy.py
See this class for additional details.
For the `+` operator to work correctly, Pipeline methods must be lazily evaluated.
Hence they return a function to be executed at the correct time by DplyFrame.
"""
